...
import com.aprilz.generate.mapper.CodegenColumnMapper;
import com.aprilz.generate.mapper.CodegenTableMapper;
...
import static com.aprilz.generate.enums.codegen.ErrorCodeConstants.*;
import static com.aprilz.generate.utils.ServiceExceptionUtil.exception;
...
public class CodegenServiceImpl implements CodegenService {
    ...
    public List<DatabaseTableRespVO> getDatabaseTableList(Long dataSourceConfigId, String name, String comment) {
        ...
        tables.removeIf(table -> table.getName().toUpperCase().startsWith("INFRA_"));
        // 移除已经生成的表
        // 移除在 Codegen 中，已经存在的
