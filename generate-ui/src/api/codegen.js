...
export function getCodegenDetail(tableId) {
    return request({
        url: '/codegen/detail?tableId=' + tableId,
        method: 'get',
    })
}
...
export function syncCodegenFromDB(tableId) {
    return request({
        url: '/codegen/sync-from-db?tableId=' + tableId,
        method: 'put'
    })
}
...
export function syncCodegenFromSQL(tableId, sql) {
    return request({
        url: '/codegen/sync-from-sql?tableId=' + tableId,
        method: 'put',
        headers:{
...
export function previewCodegen(tableId) {
    return request({
        url: '/codegen/preview?tableId=' + tableId,
        method: 'get',
    })
}
...
export function downloadCodegen(tableId) {
    return request({
        url: '/codegen/download?tableId=' + tableId,
        method: 'get',
        responseType: 'blob'
    })
}
...
export function deleteCodegen(tableId) {
    return request({
        url: '/codegen/delete?tableId=' + tableId,
        method: 'delete'
    })
